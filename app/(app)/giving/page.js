...
export default async function Giving({ searchParams }) {
  ...
  const link = (s, d) => `?type=${encodeURIComponent(type)}&sort=${s}&dir=${d}&page=1&pageSize=${pageSize}`;

  // Calculate summary statistics
  const [totalDeposits, totalWithdrawals, monthlyDeposits, monthlyWithdrawals] = await Promise.all([
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Giving & Financial Records</h1>
        <p className="mt-2 text-gray-600">Track donations, expenses, and financial transactions</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="metric-card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">This Month Deposits</p>
              <p className="text-2xl font-bold text-gray-900">
        ...
        <div className="metric-card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">This Month Withdrawals</p>
              <p className="text-2xl font-bold text-gray-900">
      ...
      <div className="card mb-8">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <a 
            className={`text-sm px-3 py-1 rounded-full transition-colors ${
              sort === 'amount' ? 'bg-blue-100 text-blue-800' : 'text-gray-600 hover:text-blue-600'
            }`}
          ...
          <a 
            className={`text-sm px-3 py-1 rounded-full transition-colors ${
              sort === 'type' ? 'bg-blue-100 text-blue-800' : 'text-gray-600 hover:text-blue-600'
            }`}
      ...
      <div className="card">
        <div className="card-header">
          <h2 className="text-xl font-semibold text-gray-900">Financial Transactions</h2>
        ...
        {items.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {type ? 'Try adjusting your filter criteria.' : 'Get started by creating a new transaction.'}
            </p>
          </div>
        ) : (
                  ...
                  <tr key={transaction.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`status-badge ${
                        transaction.type === 'DEPOSIT' ? 'status-approved' : 'status-rejected'
                      }`}>
                        {transaction.type}
                      </span>
                    </td>
