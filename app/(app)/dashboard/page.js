...
export default async function Dashboard() {
  ...
  let ann = 0, proj = 0, reqs = 0, books = 0, tx = 0, mem = 0, ev = 0, att = 0;
  
  try {
    [ann, proj, reqs, books, tx, mem, ev, att] = await Promise.all([
    ...
    <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      <div className='mb-8'>
        ...
        <p className='mt-2 text-gray-600'>
          Welcome to your ChurchFlow management dashboard
        </p>
      </div>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Add, edit, or view member information
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className='flex items-center space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Monitor donations and financial records
                  </p>
                </div>
              </div>
            </a>
