...
export default async function AccountStatements({ searchParams }) {
  ...
  let totalStatements = 0, processingStatements = 0, completedStatements = 0, failedStatements = 0;
    ...
    <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      <div className='mb-8'>
        ...
        <p className='mt-2 text-gray-600'>
          Generate and manage account statements for all church accounts
        </p>
      </div>
          ...
          <div className='text-center py-12'>
            ...
            <p className='mt-1 text-sm text-gray-500'>
              {status
                ...
                : 'Get started by generating a new statement.'}
            </p>
          </div>
        ) : (
