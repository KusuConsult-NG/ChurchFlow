    ...
    <main className='p-6 space-y-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='bg-white border border-gray-200 rounded-lg p-6'>
          <div className='flex items-center'>
            <div
              className={`p-2 rounded-lg ${remaining >= 0 ? 'bg-green-100' : 'bg-orange-100'}`}
            >
              <svg
                className={`w-6 h-6 ${remaining >= 0 ? 'text-green-600' : 'text-orange-600'}`}
                fill='none'
                stroke='currentColor'
                viewBox='0 0 24 24'
              >
            ...
            <div className='ml-4'>
              ...
              <p
                className={`text-2xl font-semibold ${remaining >= 0 ? 'text-gray-900' : 'text-orange-600'}`}
              >
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                  ...
                  <div className='text-sm'>
                    Remaining:{' '}
                    <span
                      className={`font-medium ${budget.allocatedAmount - (budget.spentAmount || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}
                    >
                      $
                      {(
