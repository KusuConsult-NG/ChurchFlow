...
export default function TwoFactorSetup() {
      ...
      <main className="max-w-md mx-auto mt-10 space-y-6">
        ...
        <div className="space-y-4">
          <div className="border border-black/10 rounded-lg p-6">
            <h3 className="font-semibold mb-2">Authenticator App (Recommended)</h3>
  ...
  if (step === 2) {
    return (
      <main className="max-w-md mx-auto mt-10 space-y-6">
        <h1 className="text-2xl font-bold text-center">Setup Authenticator App</h1>
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium">Enter 6-digit code from your app:</label>
            <input
              type="text"
          ...
          {isVerified && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <p className="text-green-800 text-sm">✅ Two-factor authentication is now enabled!</p>
            </div>
          )}
        </div>
      </main>
    ...
    return (
      <main className="max-w-md mx-auto mt-10 space-y-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6">
          <h3 className="font-semibold text-green-800 mb-2">✅ Magic Link Enabled</h3>
